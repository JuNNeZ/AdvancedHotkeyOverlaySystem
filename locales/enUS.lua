...
L.CUSTOM_ABBREVIATIONS = "Abbreviations"
L.CUSTOM_ABBREVIATIONS_DESC = "Choose the text AHOS uses for every supported modifier and key. Values are saved per profile; clearing a field restores its default."
L.ABBREVIATION_PREVIEW = "Preview (Ctrl + Shift + Mouse Button 4)"
L.ABBREVIATION_ENTRY_DESC = "Binding token: %s\nDefault: %s\nClear the field to restore the default."
L.ABBREVIATION_CLEAR_HINT = "Clear and press Enter to restore the default."
L.RESET_ABBREVIATIONS = "Reset All Abbreviations"
L.RESET_ABBREVIATIONS_DESC = "Restore every abbreviation to its built-in default."
L.RESET_ABBREVIATIONS_CONFIRM = "Reset every custom abbreviation in this profile?"
...
L.ABBREVIATIONS_DESC = "Use your configured abbreviations for keybind text."
L.MAX_LENGTH_DESC = "Maximum length of the final abbreviated hotkey."
